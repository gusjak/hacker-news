        ...
        <?php foreach ($posts as $post) : ?>
            ...
            <form action="app/posts/update.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="edit-title">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="url" name="edit-url">
                    <small class=" form-text text-muted">You may change the url by filling out this field.</small>
                </div><!-- /form-group -->

                <div class="form-group">
                    <label for="text">Text Content</label>
                    <textarea class="form-control rounded-0" name="edit-text-content" rows="5" placeholder="<?= $post['text'] ?>"></textarea>
                </div><!-- /form-group -->
