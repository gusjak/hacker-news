...
<?php $allPosts = sortAllPostsByUpvotes($pdo); ?>
    ...
    <article>
        ...
        <?php foreach ($allPosts as $post) : ?>
            ...
            <div class="card shadow p-4 mb-4 bg-card mw-100">
                ...
                <p><a class="info-text" href="<?php echo $post['url'] ?>"><?php echo $post['url'] ?></a></p>
                <p><?php echo $post['text'] ?></p>
                <small class="text-muted">Upvotes: <?php echo $upvotes; ?></small>
                <?php if ($alreadyUpvoted) : ?>
                    <form action="app/posts/upvotesindex.php" method="post">
